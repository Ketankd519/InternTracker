  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        setError(
          result.message ||
            "No certificate found for this Certificate ID."
        );
      }
    } catch (err) {
      console.error(
  ...
  return (
    <div className="certificate-verification-page">
      ...
      <div className="certificate-verification-header">
        ...
        <p>
          Verify the authenticity of an InternTrack certificate
          using its Certificate ID.
        </p>
      </div>
      ...
      <div className="certificate-verification-container">
        ...
        <div className="certificate-search-card">
          ...
          <form
            className="certificate-search-form"
            onSubmit={handleSearch}
          >

            <label
              htmlFor="certificateId"
              className="certificate-search-label"
            >
              Certificate ID
            </label>
            ...
            <div className="certificate-search-row">
              ...
              <div className="certificate-input-wrapper">
                ...
                <input
                  ...
                  id="certificateId"
                  name="certificateId"
                  className="certificate-id-input"
              ...
              <button
                type="submit"
                className="certificate-search-button"
                disabled={loading}
              >
            ...
            <p className="certificate-helper-text">
              <span className="certificate-helper-icon">
                i
              </span>
        ...
        {message && !error && (
          <div className="certificate-success-message">
            ...
            <div className="certificate-success-icon">
              ✓
            </div>
            ...
            <div>
              ...
              <p>
                The certificate details are displayed below.
              </p>
            </div>
            ...
            >
              ...
              {certificate.isVerified ? (
                <>
                  ...
                  <div>
                    <strong>
                      Student Certificate is Verified
                    </strong>

                    <p>
                      This certificate has been approved by
                      both the Teacher and Manager.
                    </p>
                  </div>
                </>
              ) : (
                <>
                  ...
                  <div>
                    ...
                    <p>
                      This certificate has not yet received
