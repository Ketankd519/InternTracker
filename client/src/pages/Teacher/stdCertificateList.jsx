...
export default function StdCertificateList() {
  ...
  const fetchCertificateStudents = async () => {
    ...
    try {
      ...
      const response =
        await API.get("/certificates/students");

      console.log(
        "CERTIFICATE STUDENTS RESPONSE:",
        response.data
      );
  ...
  const handleViewCertificate = (
    ...
    navigate(
      `/teacher/student-certificate/${studentId}`
    );
  ...
  const getInternshipStatusClass = (
    status
  ) => {
    ...
    switch (
      ...
      case "ongoing":
        return "certificate-status-ongoing";
                  ...
                  return (
                    ...
                    <tr key={studentId || index}>
                      ...
                      <td>
                        ...
                        <span
                          className={`internship-status-badge ${getInternshipStatusClass(
                            internshipStatus
                          )}`}
                        >
